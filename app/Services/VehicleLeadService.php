...
class VehicleLeadService
{
    ...
    public function leadRules(): array
    {
        return [
            ...
            'preferred_at' => 'required_if:source,test_drive|nullable|date|after_or_equal:today|before_or_equal:+60 days',
    ...
    public function leadMessages(): array
    {
        return [
            ...
            'preferred_at.before_or_equal' => 'Please pick a test drive date within the next 60 days.',
