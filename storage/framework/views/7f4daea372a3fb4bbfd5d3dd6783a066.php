...
<head>
    ...
    <title>Page Not Found — <?php echo e($site['brand']['name']); ?></title>
...
<main class="e-wrap">
    <div class="e-inner">
        ...
        <div class="e-actions">
            <?php if($isAdmin): ?>
                <a class="e-btn e-btn-primary" href="<?php echo e(url('/dashboard')); ?>">Back to Dashboard</a>
                <a class="e-btn e-btn-ghost" href="javascript:history.back()">Go Back</a>
            <?php else: ?>
                <a class="e-btn e-btn-primary" href="<?php echo e($home); ?>">Back to Home</a>
                <?php if (! ($isAdmin)): ?>
                    <a class="e-btn e-btn-accent" href="<?php echo e(route('site.new-autos')); ?>">Browse New Autos</a>
                <?php endif; ?>
                <a class="e-btn e-btn-ghost" href="javascript:history.back()">Go Back</a>
            <?php endif; ?>
        </div>
        ...
        <?php if (! ($isAdmin)): ?>
            <form class="e-search" action="<?php echo e(route('site.search')); ?>" method="GET" role="search">
...
<footer class="e-foot">
    <?php if($isAdmin): ?>
        <?php echo e($site['brand']['name']); ?> Admin
    <?php else: ?>
        Still stuck? Call or WhatsApp
        <a href="https://wa.me/<?php echo e($site['contact']['whatsapp']); ?>" target="_blank" rel="noopener">
            <?php echo e($site['contact']['phone']); ?>

        </a>
        &nbsp;·&nbsp; <?php echo e($site['brand']['copyright']); ?>
...
<?php /**PATH C:\xampp\htdocs\autobazaar\resources\views/errors/404.blade.php ENDPATH**/ ?>