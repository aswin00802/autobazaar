...
/**
 * `auto_enquiries_my_local` — read from the live database, which had no migration for it.
 *
...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('auto_enquiries_my_local')) {
            return;
        }

        Schema::create('auto_enquiries_my_local', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('auto_enquiries_my_local');
    }
};
