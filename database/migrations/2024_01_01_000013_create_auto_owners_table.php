...
/**
 * `auto_owners` — read from the live database, which had no migration for it.
 *
...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('auto_owners')) {
            return;
        }

        Schema::create('auto_owners', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('auto_owners');
    }
};
