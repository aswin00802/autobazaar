...
/**
 * `auto_fuel_types` — read from the live database, which had no migration for it.
 *
...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('auto_fuel_types')) {
            return;
        }

        Schema::create('auto_fuel_types', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('auto_fuel_types');
    }
};
