...
<body>
    ...
    <script type="text/javascript">
        $('.opt_form').on('submit', function(e) {
            ...
            // The number and the type are printed by the server into the hidden
            // inputs above. Reading them back out of window.location.pathname
            // only worked if the site sat at one exact folder depth.
            $('#fullOtp').val(otp)
