...
<div class="row">
    <form method="post" action="{{ route('auto-management.used-auto.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="auto_usage_status" value="used_auto">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
            <div class="card">
                <div class="card-header text-center">
                    <h4>Used Auto Create</h4>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
