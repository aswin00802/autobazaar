...
@section('title')
Auto Management / Bajaj ReFinance Auto Update
@endsection
...
<div class="row">
    <form method="post" action="{{ route('auto-management.bajaj-refinance-auto.update') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
            <div class="card">
                <div class="card-header text-center">
                    <h4>Bajaj ReFinance Auto Update</h4>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
