                            ...
                            @foreach($new_autos as $auto)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('auto-management.new-auto.view-details',Crypt::encryptString($auto->id)) }}" class="btn btn-xs btn-twitter waves-effect waves-light text-white"><i class="icon-base ri ri-eye-line icon-16px me-2"></i>More</a>
                                        @endcan
                                    </td>
                                    <td>
                                         @can('edit_new_auto')
