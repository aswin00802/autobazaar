...
@section('title')
Auto Management / New Auto Update
@endsection
...
<div class="row">
    <form method="post" action="{{ route('auto-management.new-auto.update') }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('orp',$auto->orp) }}" id="orp" class="form-control" placeholder="Enter On Road Price" name="orp">
                                @error('orp')
                                    <span style="color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('passenger_capacity',$auto->passenger_capacity) }}" id="passenger_capacity" class="form-control" placeholder="Enter Passenger Capacity" name="passenger_capacity">
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('gear',$auto->gear) }}" id="gear" class="form-control" placeholder="Enter Gear" name="gear">
                                @error('gear')
                                    <span style="color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('millage',$auto->millage) }}" id="millage" class="form-control" placeholder="Enter Millage" name="millage">
                                @error('millage')
                                    <span style="color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('engine_cc',$auto->engine_cc) }}" id="engine_cc" class="form-control" placeholder="Enter Engine CC" name="engine_cc">
                                @error('engine_cc')
                                    <span style="color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('free_service',$auto->free_service) }}" id="free_service" class="form-control" placeholder="Enter Free Service" name="free_service">
                                @error('free_service')
                                    <span style="color:red;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('finance_arrangements',$auto->finance_arrangements) }}" id="finance_arrangements" class="form-control" placeholder="Enter Finance Arrangements" name="finance_arrangements">
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="mb-4">
                                ...
                                <input type="text" value="{{ old('vehicle_suitable',$auto->vehicle_suitable) }}" id="vehicle_suitable" class="form-control" placeholder="Enter Vehicle Suitable" name="vehicle_suitable">
