...
@section('title')
Auto Management / Private Cargo Auto Create
@endsection
...
<div class="row">
    <form method="post" action="{{ route('auto-management.private-cargo-auto.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="auto_usage_status" value="private_cargo">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
            <div class="card">
                <div class="card-header text-center">
                    <h4>Private Cargo Auto Create</h4>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-2">
