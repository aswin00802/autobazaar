...
@section('title')
Spare Parts / Sub Categories Add
@endsection
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-card-center">Sub Categories Create</h4>
            </div>
            <div class="card-content collapse show">
                <div class="card-body">
                    <form class="form" action="{{ route('spare-parts.sub-categories.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="form-actions center">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-check-square-o"></i> Create SubCategories
                            </button>
                        </div>
                    </form>
                </div>
