    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-card-center">Seller Create</h4>
            </div>
            <div class="card-content collapse show">
                <div class="card-body">
                    <form class="form" action="{{ route('masters.auto-seller.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-6">
                            <label class="form-label" for="">Seller Name</label>
                            <input type="text" value="{{ old('seller_name') }}" id="seller_name" class="form-control" placeholder="Enter Seller Name" name="seller_name">
                            @error('seller_name')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" value="{{ old('seller_type') }}" id="seller_type" class="form-control" placeholder="Enter Seller Type" name="seller_type">
                            @error('seller_type')
                                <span style="color:red;">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-actions center">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-check-square-o"></i> Create Seller
                            </button>
                        </div>
                    </form>
                </div>
