    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    <form class="form" action="{{ route('masters.city.update') }}" method="post">
                        @csrf
                        ...
                        <div class="mb-6">
                            <label class="form-label" for="">State Name</label>
                            <input type="text" value="{{ old('name', $city->name) }}" id="name" class="form-control" placeholder="Enter State Name" name="name">
                            @error('name')
                                <span style="color:red;">{{ $message }}</span>
                            @enderror
                        </div>
