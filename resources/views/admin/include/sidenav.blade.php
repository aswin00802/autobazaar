{{--
    ...
    Grouped by how the team works: marketplace operations first, then FairPrice
    rides (a separate ride-hailing product), then content, then one-time setup. Every item keeps its original route name and
    permission; a group only renders if the user can see at least one child.

    Private Cargo and Bajaj Re-Finance are hidden from the menu on purpose.
    Their routes and screens still exist (the mobile app lists those autos),
    so they stay reachable by URL.
--}}
@php
    $listingRoutes = [
...
<aside id="layout-menu" class="layout-menu menu-vertical menu">
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- E-commerce: website orders and coupons, plus the product catalogue --}}
        ...
        <li class="menu-item {{ areActiveRoutesList($ecommerceRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ areActiveRoutes(['ecommerce.orders','ecommerce.orders.status','ecommerce.orders.view']) }}">
                ...
                <li class="menu-item {{ areActiveRoutes(['ecommerce.coupons','ecommerce.coupons.create','ecommerce.coupons.edit']) }}">
                ...
                @endcan
                {{-- Orders placed from the mobile app (sparepart_orders) --}}
                @canany(['sparepart_pendingorders','sparepart_successorders','sparepart_cancelorders'])
                <li class="menu-item {{ areActiveRoutesList($legacyOrderRoutes) }}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        {{-- Services: directories and requests from the mobile app --}}
        @canany(['gas_station','mechanic','insurance','re_finance','rto'])
        <li class="menu-item {{ areActiveRoutesList($serviceRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        {{-- ================================================================ RIDES
             FairPrice ride-hailing (driver and customer apps), run separately
             from the marketplace. --}}
        @canany($ridePermissions)
        <li class="menu-header small mt-4">
            <span class="menu-header-text">Rides</span>
        </li>
        <li class="menu-item {{ areActiveRoutesList($driverRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                @endcan
                @can('auto_meter')
                <li class="menu-item {{ areActiveRoutes(['auto-meter','auto-meter.invoice']) }}">
        ...
        {{-- ================================================================ SETUP --}}
        @canany($setupPermissions)
        <li class="menu-header small mt-4">
            <span class="menu-header-text">Setup</span>
        </li>
        @endcanany

        {{-- Masters: reference data every other screen picks from --}}
        @canany(['auto_brand','auto_brand_model','auto_fuel_type','auto_seller','authorized_seller','auto_finance','country','state','city'])
        <li class="menu-item {{ areActiveRoutesList($masterRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        {{-- Users & Access: customer accounts and who can do what in the admin --}}
        @canany(['user_list','roles','permissions','role_has_permission'])
        <li class="menu-item {{ areActiveRoutesList($accessRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                @endcan
                @can('permissions')
                <li class="menu-item {{ areActiveRoutes(['permissions','permissions.create','permissions.edit']) }}">
                ...
                <li class="menu-item {{ areActiveRoutes(['role_has_permission','role_has_permission.edit']) }}">
        ...
        <li class="menu-item {{ areActiveRoutesList($settingRoutes) }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
