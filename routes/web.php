...
// Customer website (new AutoBazaar frontend). See routes/site.php.
...
//frontend routes
    ...
    // Policy URLs are linked from the app store listings, so the paths stay;
    // they now render the new site's policy pages.
    ...
    // Account deletion — required by the Play Store listing.
...
// Route::get('/opt-send',[App\Http\Controllers\Auth\OTPController::class,'opt_send']);
